...
cmd = 'python3 vehicle/vehicle.py -i %d -d %s -l input/locations/0.txt --adaptive 1 -c input/helpee_conf/%s > %d-node%d-%s.txt' % \
    (vehicle_id, data_dir, helpee_conf, int(start_time), vehicle_id, helpee_confs[vehicle_id])
