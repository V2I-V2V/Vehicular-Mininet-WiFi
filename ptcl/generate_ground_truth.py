...
label1 = np.fromfile('/Users/ry4nzzz/Documents/research/V2I+V2V/Carla/labels/86/1000.label', dtype=np.uint32)
# label1.astype(np.uint16)
label2 = np.fromfile('/Users/ry4nzzz/Documents/research/V2I+V2V/Carla/labels/130/1000.label', dtype=np.uint32)
...
ptcl = ptcl_utils.read_ptcl_data('/Users/ry4nzzz/Documents/research/V2I+V2V/Carla/lidar/86/1000.npy')
ptcl[:, 3] = 1
trans = np.load('/Users/ry4nzzz/Documents/research/V2I+V2V/Carla/lidar/86/1000.trans.npy')
ptcl = np.dot(trans, ptcl[:, :4].T).T

ptcl2 = ptcl_utils.read_ptcl_data('/Users/ry4nzzz/Documents/research/V2I+V2V/Carla/lidar/130/1000.npy')
ptcl2[:, 3] = 1
trans2 = np.load('/Users/ry4nzzz/Documents/research/V2I+V2V/Carla/lidar/130/1000.trans.npy')
...
# np.save('86_gt.npy', points_truth_labeled)
np.save('130_gt.npy', ptcl2)

merged = np.vstack([points_truth_labeled, ptcl2])
np.save('86_130_gt_1000.npy', merged)
